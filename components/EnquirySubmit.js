...
export default class EnquirySubmit extends Component {
    ...
    render() {
        return (
            <View style={styles.container}>
              ...
              <Text style={styles.title}>Thank You for submitting your question </Text>
              <Text style={styles.title}>We will review and get back to you </Text>
